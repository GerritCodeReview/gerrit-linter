...
// errIrrelevant is a marker error value used returned for checkers that don't apply
...
// pendingLoop is the checker polling loop.
...
// executeCheck executes the pending checks given its argument.
